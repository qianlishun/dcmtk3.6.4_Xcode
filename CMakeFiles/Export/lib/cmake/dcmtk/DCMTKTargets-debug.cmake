...
set_target_properties(ofstd PROPERTIES
  ...
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "/usr/lib/libiconv.dylib;/usr/lib/libcharset.dylib;pthread"
...
set_target_properties(ofstd_tests PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/ofstd_tests"
  )
...
set_target_properties(dcm2xml PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/dcm2xml"
  )
...
set_target_properties(dcmconv PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/dcmconv"
  )
...
set_target_properties(dcmcrle PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/dcmcrle"
  )
...
set_target_properties(dcmdrle PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/dcmdrle"
  )
...
set_target_properties(dcmdump PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/dcmdump"
  )
...
set_target_properties(dcmftest PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/dcmftest"
  )
...
set_target_properties(dcmgpdir PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/dcmgpdir"
  )
...
set_target_properties(dump2dcm PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/dump2dcm"
  )
...
set_target_properties(xml2dcm PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/xml2dcm"
  )

list(APPEND _IMPORT_CHECK_TARGETS xml2dcm )
list(APPEND _IMPORT_CHECK_FILES_FOR_xml2dcm "${_IMPORT_PREFIX}/bin/xml2dcm" )

# Import target "stl2dcm" for configuration "Debug"
set_property(TARGET stl2dcm APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(stl2dcm PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/stl2dcm"
  )
...
set_target_properties(pdf2dcm PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/pdf2dcm"
  )
...
set_target_properties(dcm2pdf PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/dcm2pdf"
  )
...
set_target_properties(img2dcm PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/img2dcm"
  )
...
set_target_properties(dcm2json PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/dcm2json"
  )

list(APPEND _IMPORT_CHECK_TARGETS dcm2json )
list(APPEND _IMPORT_CHECK_FILES_FOR_dcm2json "${_IMPORT_PREFIX}/bin/dcm2json" )

# Import target "cda2dcm" for configuration "Debug"
set_property(TARGET cda2dcm APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(cda2dcm PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/cda2dcm"
  )
...
set_target_properties(dcmodify PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/dcmodify"
  )
...
set_target_properties(dcmdata_tests PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/dcmdata_tests"
  )
...
set_target_properties(dcmrecv PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/dcmrecv"
  )
...
set_target_properties(dcmsend PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/dcmsend"
  )
...
set_target_properties(echoscu PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/echoscu"
  )
...
set_target_properties(findscu PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/findscu"
  )
...
set_target_properties(getscu PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/getscu"
  )
...
set_target_properties(movescu PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/movescu"
  )
...
set_target_properties(storescp PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/storescp"
  )
...
set_target_properties(storescu PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/storescu"
  )
...
set_target_properties(termscu PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/termscu"
  )
...
set_target_properties(dcmnet_tests PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/dcmnet_tests"
  )
